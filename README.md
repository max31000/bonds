...
**Этапы 01–08 выполнены** (фундамент/CI-конфигурация, Telegram-авторизация, доменная
...
Фронтовые дашборды (этап 09) — ещё не реализованы.
...
## MVP-ограничения (после этапа 08)

- Фронтовых дашборд сверх логина нет — этап 09. Backend API полностью готов и
  задокументирован в Swagger, фронту есть на что опираться.
...
- Деплой на живой VDS не выполнялся ни на одном из этапов 01–08 — см. "Деплой — TODO".
