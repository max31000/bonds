...
public static class GSpreadCalculator
{
    ...
    /// сопоставления — дюрация Маколея бумаги в годах (T-7/L-1: тот же измеритель срока, что
    /// и ось X scatter, чтобы визуальное «над/под кривой» совпадало со знаком G-спреда;
    /// Маколей — естественный срок-к-потокам, точнее сравнивать по нему, чем по сроку до
    /// погашения, особенно для амортизируемых бумаг). Возвращается в долях (напр. 0.015 = 150 б.п.).
    /// </summary>
